...
// A couple patches assume that timed input is available, as they use
// that to simulate a sleep. If timed input is not available, though, it
// will instead just be a regular @read_char, which will block till the
