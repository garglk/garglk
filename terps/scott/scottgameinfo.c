...
const struct GameInfo games[] = {
    ...
    {
        "Questprobe 1: The Hulk C64", HULK_C64,
        NO_TYPE,                  // type
        ENGLISH,                  // subtype
        FOUR_LETTER_UNCOMPRESSED, // dictionary type
    ...
    {
        "The Sorcerer of Claymorgue Castle C64",
        CLAYMORGUE_C64,
        NO_TYPE,                  // type
        ENGLISH | C64,            // subtype
        FIVE_LETTER_UNCOMPRESSED, // dictionary type
    ...
    {
        "Arrow of Death part 1 DAT version",
        SCOTTFREE,
        NO_TYPE,                 // type
        MYSTERIOUS,                   // subtype
        FOUR_LETTER_UNCOMPRESSED, // dictionary type
    ...
    {
        "Arrow of Death part 2 DAT version",
        SCOTTFREE,
        NO_TYPE,                 // type
        MYSTERIOUS,                   // subtype
        FOUR_LETTER_UNCOMPRESSED, // dictionary type
    ...
    {
        "Escape from Pulsar 7 DAT version",
        SCOTTFREE,
        NO_TYPE,                 // type
        MYSTERIOUS,                   // subtype
        FOUR_LETTER_UNCOMPRESSED, // dictionary type
    ...
    {
        "Feasibility Experiment DAT version",
        SCOTTFREE,
        NO_TYPE,                 // type
        MYSTERIOUS,                   // subtype
        FOUR_LETTER_UNCOMPRESSED, // dictionary type
    ...
    {
        "The Wizard of Akyrz DAT version",
        SCOTTFREE,
        NO_TYPE,                 // type
        MYSTERIOUS,                   // subtype
        FOUR_LETTER_UNCOMPRESSED, // dictionary type
    ...
    {
        "Perseus and Andromeda DAT version",
        SCOTTFREE,
        NO_TYPE,                 // type
        MYSTERIOUS,                   // subtype
        FOUR_LETTER_UNCOMPRESSED, // dictionary type
    ...
    {
        "Ten Little Indians DAT version",
        SCOTTFREE,
        NO_TYPE,                 // type
        MYSTERIOUS,                   // subtype
        FOUR_LETTER_UNCOMPRESSED, // dictionary type
