...
static const char lowerCaseCharacters[] = "abcdefghijklmnopqrstuvwxyz‡·‚„‰ÂÊÁÈÍÎÏÌÓÔÒÚÛÙıˆ¯˘˙˚¸˝˛ˇ";

static const char upperCaseCharacters[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ¿¡¬√ƒ≈∆«… ÀÃÕŒœ–—“”‘’÷ÿŸ⁄€€›ﬁﬂ";
