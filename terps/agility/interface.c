...
/* Use strings in l_stat and r_stat */
{
  ...
  s=rmalloc((status_width+1)*sizeof(char));
   ...
   as the case may be */
{
  ...
  switch(ft) 
    {
    case 0: last_script=fc;break;
    case 1: last_save=fc; break;
    case 2: last_save=fc; break;
    case 3: last_log=fc; break;
    case 4: last_log=fc; break;
    }
