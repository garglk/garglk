...
static unsigned char lowerCaseCharacters[] = "abcdefghijklmnopqrstuvwxyz‡·‚„‰ÂÊÁÈÍÎÏÌÓÔÒÚÛÙıˆ¯˘˙˚¸˝˛ˇ";

static unsigned char upperCaseCharacters[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ¿¡¬√ƒ≈∆«… ÀÃÕŒœ–—“”‘’÷ÿŸ⁄€€›ﬁﬂ";
