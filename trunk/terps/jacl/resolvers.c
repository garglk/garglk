/* resolvers.c --- Take an entity label and return either the value of that
 *                 entity or a pointer to it.
 * (C) 1992 - 2008 Stuart Allen, distribute and use 
	 ...
	 char           *attribute;
{
	...
	if (!strcmp(attribute, "VISITED"))
		...
		return (SITTING);
	else if (!strcmp(attribute, "FIRST"))
		return (FIRST);
