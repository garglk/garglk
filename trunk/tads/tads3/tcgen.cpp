                                     ...
                                     const textchar_t *fname)
{
     ...
     *   and read each one.  
     */
    for (anchor_cnt = (ulong)fp->read_int4() ; anchor_cnt != 0 ;
         --anchor_cnt)
    {
        ulong anchor_ofs;
        size_t sym_len;
        ...
        anchor_ofs = osrp4(buf) + start_ofs;
                                  ...
                                  CTcIdFixup **fixup_list_head)
{
    ...
    for (cnt = (ulong)fp->read_int4() ; cnt != 0 ; --cnt)
    {
        char buf[9];
        ulong ofs;
        ulong old_id;
