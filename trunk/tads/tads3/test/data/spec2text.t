...
{
    local strs = [
        'This is a test of the specialsToText() conversion process.',
        ...
        'Some entity markups: &quot;Quotes&quot;, &ldquo;Curly '
        + 'Quotes&rdquo;, &lsquo;Single Curlies&rsquo;, &lt;angle '
    ...
    foreach (local str in strs)
    {
        "Src:\ \ <<quoteAll(str)>><br>
        Disp: <<str.htmlify()>><br>
        s2t:\ \ <<quoteAll(str.specialsToText(st))>><br><br>";
    }
}
